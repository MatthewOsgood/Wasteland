...
public abstract class Character extends Movable {
     ...
     */
    public Character(SteampunkGame game, TexturePath texturePath, World world, Map map, float posX, float posY, float width, float height, float moveSpeed) {
        super(game, texturePath, world, map, posY, posX, width, height, moveSpeed);
    }

    public Character(SteampunkGame game, TexturePath texturePath, World world, Map map, float posX, float posY, float width, float height) {
        super(game, texturePath, world, map, posY, posX, width, height, 3);
    }

    public Character(SteampunkGame game, TexturePath texturePath, World world, Map map, float posX, float posY) {
        super(game, texturePath, world, map, posY, 1f, 1f, posX);
    }
