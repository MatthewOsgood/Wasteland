...
public class Bullet extends Projectile<Bullet> {
     ...
     */
    public Bullet(SteampunkGame game, Map map, World world, TexturePaths texturePaths, float posX, float posY, float width, float height, float moveSpeed, int health, int damage) {
    ...
    public static class Builder extends Projectile.Builder<Bullet, Builder> {
         ...
         */
        @Override
        public Bullet build(SteampunkGame game, Map map, World world) {
