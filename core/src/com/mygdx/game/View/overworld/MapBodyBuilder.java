...
/**
 * credit: <a href="https://gamedev.stackexchange.com/questions/66924/how-can-i-convert-a-tilemap-to-a-box2d-world">...</a>
 */
public class MapBodyBuilder {
    ...
    public static Array<Body> buildShapes(Map map, float pixels, World world) {
        ...
        for(MapObject object : objects) {
            ...
            fDef.shape = shape;
            fDef.filter.categoryBits = BitFilters.OBSTACLE;
            fDef.density = 1f;
